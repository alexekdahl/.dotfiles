...
static void render_logo(void) {
    static char layer_name[17] = " Active Layer: 0"; // Initialize layer name string
    layer_name[15] = '0' + biton32(layer_state); // Update layer name with current active layer number
