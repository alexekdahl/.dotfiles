...
vim.g.colors_name = "tachyon-light"
...
local highlights = {
  ...
  PmenuSel                    = { fg = c.ui_select_fg, bg = c.ui_select_bg, bold = true },
  ...
  SnacksExplorerSelection     = { fg = c.ui_select_fg, bg = c.ui_select_bg, bold = true },
  SnacksExplorerCursorLine    = { bg = c.base01 },

  SnacksExplorerHidden        = { fg = c.base05 },

  SnacksExplorerPreviewNormal = { fg = c.base05, bg = c.base01 },
  SnacksExplorerPreviewBorder = { fg = c.base03, bg = c.base01 },

  SnacksExplorerTitle         = { fg = c.base0E, bold = true },

  SnacksPickerNormal          = { fg = c.base05, bg = c.base01 },
  SnacksPickerBorder          = { fg = c.base03, bg = c.base01 },
  SnacksPickerTitle           = { fg = c.base0D, bold = true },
  SnacksPickerMatch           = { fg = c.base0A },
  SnacksPickerSelection       = { fg = c.ui_select_fg, bg = c.ui_select_bg, bold = true },
  ...
  SnacksMenuNormal            = { fg = c.base05, bg = c.base01 },
  SnacksMenuBorder            = { fg = c.base03, bg = c.base01 },
  SnacksMenuSelection         = { fg = c.ui_select_fg, bg = c.ui_select_bg, bold = true },
